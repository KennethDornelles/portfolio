  ...
  template: `
    <div class="space-y-4 lg:space-y-6">
      ...
      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h1 class="text-xl lg:text-2xl font-bold text-white">{{ 'DASH_TITLE' | translate }}</h1>
          <p class="text-sm lg:text-base text-gray-400">{{ 'DASH_SUBTITLE' | translate }}</p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Projects -->
        <div class="p-4 lg:p-6 bg-gradient-to-br from-tech-blue/10 to-transparent rounded-2xl border border-white/10">
          ...
          <p class="text-2xl lg:text-3xl font-bold text-white">{{ stats().projects }}</p>
          <p class="text-gray-400 text-xs lg:text-sm">{{ 'DASH_STAT_PROJECTS' | translate }}</p>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Recent Activity -->
        <div class="lg:col-span-2 bg-white/5 rounded-2xl border border-white/10 p-4 lg:p-6">
          <div class="flex items-center justify-between mb-4 lg:mb-6">
            <h2 class="text-base lg:text-lg font-semibold text-white">{{ 'DASH_ACT_TITLE' | translate }}</h2>
            <button class="text-tech-blue text-xs lg:text-sm hover:underline">{{ 'DASH_BTN_VIEW_ALL' | translate }}</button>
          </div>
