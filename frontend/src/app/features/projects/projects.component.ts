      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
          ...
          <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">
            {{ 'PROJECTS_TITLE_PREFIX' | translate }}
            <span
              class="text-transparent bg-clip-text bg-gradient-to-r from-tech-blue to-purple-500"
              >{{ 'PROJECTS_TITLE_SUFFIX' | translate }}</span
            >
          </h1>
          ...
          @for (project of projects; track project.name) {
            <app-case-study-card [color]="project.color">
              ...
              <app-case-preview
                ...
                [tagline]="project.taglineKey | translate"
              ...
              <div class="flex items-start justify-between mb-6">
                ...
                <a
                  ...
                  [attr.aria-label]="
                    'Abrir repositório de ' + project.name + ' no GitHub (nova aba)'
                  "
              ...
              <div class="space-y-4 mb-6">
                <div class="p-4 bg-red-500/5 rounded-xl border border-red-500/10">
                  <span class="text-red-400 text-xs font-medium uppercase tracking-wider">{{
                    'PROJECT_PROBLEM_LABEL' | translate
                  }}</span>
                ...
                <div class="p-4 bg-green-500/5 rounded-xl border border-green-500/10">
                  <span class="text-green-400 text-xs font-medium uppercase tracking-wider">{{
                    'PROJECT_SOLUTION_LABEL' | translate
                  }}</span>
                ...
                @if (project.impactKey | translate; as impact) {
                  @if (impact !== project.impactKey) {
                    <div class="p-4 bg-tech-blue/5 rounded-xl border border-tech-blue/10">
                      <span class="text-tech-blue text-xs font-medium uppercase tracking-wider">{{
                        'PROJECT_IMPACT_LABEL' | translate
                      }}</span>
              ...
              <div class="mb-6">
                <h4 class="text-sm font-medium text-gray-400 uppercase tracking-wider mb-3">
                  {{ 'PROJECT_HIGHLIGHTS_LABEL' | translate }}
                </h4>
                <div class="space-y-3">
                    ...
                    <div class="flex gap-3">
                      ...
                      <div>
                        <span class="text-white font-medium"
                          >{{ highlight.titleKey | translate }}:</span
                        >
                        <span class="text-gray-400 text-sm">
                          {{ highlight.descriptionKey | translate }}</span
                        >
                      </div>
                    </div>
                  }
              ...
              <div class="flex flex-wrap gap-2">
                @for (tech of project.techStack; track tech) {
                  <span
                    class="px-3 py-1 bg-white/5 text-gray-300 text-xs rounded-full border border-white/10"
                  >
                    {{ tech }}
                  </span>
                }
        ...
        <div class="mb-16">
          <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-white">
              {{ 'PROJECT_CODE_TITLE' | translate }}
              <span class="text-tech-blue">{{ 'PROJECT_CODE_SUFFIX' | translate }}</span>
            </h2>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="rounded-2xl overflow-hidden border border-white/10">
              <div
                class="bg-graphite-900 px-4 py-3 flex items-center justify-between border-b border-white/10"
              >
              ...
              <pre
                class="bg-graphite-950 p-4 overflow-x-auto text-sm"
              ><code class="text-gray-300"><span class="text-purple-400">&#64;Injectable</span>()
...
&#125;</code></pre>
        ...
        <div class="text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Abrir perfil de Kenneth Dornelles no GitHub (nova aba)"
