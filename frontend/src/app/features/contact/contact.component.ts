        ...
        @if (submitted()) {
          <div class="p-6 bg-green-500/10 border border-green-500/30 rounded-2xl text-center mb-8">
            ...
            <h3 class="text-xl font-bold text-white mb-2">
              {{ 'CONTACT_SUCCESS_TITLE' | translate }}
            </h3>
          ...
          <form (ngSubmit)="onSubmit()" class="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                [placeholder]="'CONTACT_MESSAGE_PLACEHOLDER' | translate"
              ></textarea>
            </div>
            ...
            >
              @if (submitting()) {
                <span
                  class="animate-spin h-5 w-5 border-2 border-black/30 border-t-black rounded-full"
                ></span>
              }
              {{ 'BTN_SEND' | translate }}
            </button>
            ...
            @if (error()) {
              <div
                class="p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-center"
              >
                {{ error() }}
              </div>
            }
